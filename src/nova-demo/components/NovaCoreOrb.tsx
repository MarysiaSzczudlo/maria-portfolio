...
export function phaseToNovaCoreState(phase:DemoPhase):NovaCoreState {
  switch(phase){case'idle':case'composing':return'ready';case'planning':return'planning';case'delegating':return'understanding';case'working':case'resuming':return'working';case'attention':case'deciding':return'needs-approval';case'partial':return'paused';case'complete':return'completed';default:return'ready';}
}
